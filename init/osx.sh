...
# Disable DiskUtility disk image verification
...
open "${HOME}/.dotfiles/apps/Terminal/Solarized\ Dark.terminal"
...
while true; do
  read -p "Do you wish to restart your Mac (recommended)?[Yn]" yn
  case $yn in
